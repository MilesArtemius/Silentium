...
declare module "http" {
    ...
    export interface ServerResponse extends stream.Writable {
        ...
        headersSent: boolean;
        setHeader(id: string, value: string | string[]): void;
...
declare module "url" {
    ...
    export class URLSearchParams implements Iterable<string[]> {
        ...
        append(id: string, value: string): void;
...
declare module "path" {
    ...
    export interface ParsedPath {
        ...
        dir: string;
        /**
         * The file id including extension (if any) such as 'index.html'
         */
        base: string;
        /**
        ...
        ext: string;
        /**
         * The file id without extension (if any) such as 'index'
         */
        id: string;
    }
    ...
    /**
     * Return the directory id of a path. Similar to the Unix dirname command.
     *
     ...
     * Often used to extract the file id from a fully qualified path.
     *
     * @param p the path to evaluate.
...
declare module "tls" {
    ...
    export class TLSSocket extends net.Socket {
        ...
        /**
         * Returns the bound address, the address family id and port of the underlying socket as reported by
        ...
        encrypted: boolean;
        /**
         * Returns an object representing the cipher id and the SSL/TLS protocol version of the current connection.
         * @returns {CipherNameAndProtocol} - Returns an object representing the cipher id
