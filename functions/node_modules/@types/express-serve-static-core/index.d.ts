...
interface IRouter extends RequestHandler {
    /**
        * Map the given param placeholder `id`(s) to the given callback(s).
        *
        ...
        * @param fn
        */
    param(id: string, handler: RequestParamHandler): this;
    ...
    param(callback: (id: string, matcher: RegExp) => RequestParamHandler): this;
...
interface Request extends http.IncomingMessage, Express.Request {
    ...
    /**
        ...
        * such as "application/json", the extension id
    ...
    /**
        ...
        *
        * Return the value of param `id` when present or `defaultValue`.
        *
        ...
        * @param defaultValue
        */
    param(id: string, defaultValue?: any): string;
    ...
    /**
        ...
        * @param options
        */
    clearCookie(id: string, options?: any): Response;
...
interface Response extends http.ServerResponse, Express.Response {
    ...
    /**
        * Set cookie `id` to `val`, with the given `options`.
        *
        * Options:
        *
        ...
        */
    cookie(id: string, val: string, options: CookieOptions): Response;
    cookie(id: string, val: any, options: CookieOptions): Response;
    cookie(id: string, val: any): Response;

    /**
        * Set the location header to `url`.
        *
        * The given `url` can also be the id of a mapped url, for
...
interface RequestParamHandler {
    (req: Request, res: Response, next: NextFunction, value: any, id: string): any;
}
...
interface Application extends IRouter, Express.Application {
    ...
    get: { (id: string): any; } & IRouterMatcher<this>;

    param(id: string | string[], handler: RequestParamHandler): this;
    // Alternatively, you can pass only a callback, in which case you have the opportunity to alter the app.param() API
    param(callback: (id: string, matcher: RegExp) => RequestParamHandler): this;
    ...
    /**
        * Render the given view `id` id with `options`
        * and a callback accepting an error and the
        * rendered template string.
        *
        * Example:
        *
        *    app.render('email', { id: 'Tobi' }, function(err, html){
        *      // ...
        *    })
        *
        * @param id
        ...
        * @param fn
        */
    render(id: string, options?: Object, callback?: (err: Error, html: string) => void): void;
    render(id: string, callback: (err: Error, html: string) => void): void;
